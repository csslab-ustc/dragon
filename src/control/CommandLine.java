...
public class CommandLine {
    ...
    public CommandLine() {
        this.args = List.of(
                new Arg("embed",
                        null,
                        "embed comment into generated CFG",
                        Kind.Empty,
                        (_) -> {
                            Control.Cfg.embedComment = true;
                        }),
                new Arg("builtin",
                        "<file>",
                ...
                new Arg("dump",
                        ...
                        (Object x) -> {
                            switch ((String) x) {
                                ...
                                case "token" -> Control.Frontend.dumpToken = true;
                                default -> error("unknown argument: " + x);
                            }
                        }),
                new Arg("help",
                ...
                new Arg("trace",
                        ...
                        (Object x) -> {
                            String name = (String) x;
                            Control.tracedMethodNames.add(name);
                        }),
                new Arg("verbose",
                        "{0|1|2}",
                        "how verbose to be",
    ...
    public void usage() {
        ...
        System.out.println(
                "The Dragon compiler. Copyright (C) " + startYear + "-, SSE of USTC.\n" +
                        "Usage: java main.Dragon [options] <filename>\n");
        output();
    }
}
